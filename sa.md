...
1. Модель разработки:
	...
	•	Что это: `Модель разработки` описывает структуру и этапы жизненного цикла проекта, а также последовательность выполнения этих этапов.

	•	Примеры:

	•	Каркасная модель: Быстрое создание базового каркаса системы, который затем наполняется функциональностью.

	•	Модель прототипирования: Создание прототипов, которые дорабатываются на основе обратной связи от пользователей.

	•	Спиральная модель: Проект проходит через повторяющиеся циклы (итерации), каждый из которых включает планирование, анализ рисков, разработку и тестирование.

	•	V-образная модель: Линейная модель с четко определенными этапами разработки и тестирования, где каждый этап разработки имеет соответствующий этап тестирования.

2. Методология разработки:

	•	Что это: `Методология` — это набор принципов, практик и подходов к управлению проектом и процессу разработки, которые помогают эффективно организовать работу команды.

	•	Примеры:

	•	Agile: Гибкий подход, ориентированный на итеративную разработку, тесное взаимодействие с заказчиком и готовность к изменениям.

	•	Scrum: Конкретная реализация Agile, с определенными ролями, событиями и артефактами.

	•	Kanban: Метод управления задачами и оптимизации потока работ через визуализацию и постепенные улучшения.

### Основное различие:

	•	Модель разработки отвечает на вопрос “Как будет организован процесс разработки? Какие этапы будут пройдены?” Это структурный подход к проекту.

	•	Методология отвечает на вопрос “Каким образом будет организована работа команды? Как управлять проектом и взаимодействовать в рамках этого процесса?” Это организационный и управленческий подход.

...
```
| Subject ID | Subject      | Professor ID | Professor Name |
|------------|--------------|--------------|----------------|
| 1          | Math         | 101          | Prof. Smith    |
| 2          | Physics      | 102          | Prof. Johnson  |
| 3          | Chemistry    | 103          | Prof. Williams |
```

Таблицы в 3NF:

```
| Subject ID | Subject      | Professor ID |
|------------|--------------|--------------|
| 1          | Math         | 101          |
| 2          | Physics      | 102          |
| 3          | Chemistry    | 103          |

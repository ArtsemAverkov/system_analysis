...
> Придерживаются принципа `"маленькие и независимые"`. Каждый микросервис — это небольшая часть, которая может разрабатываться, развертываться и масштабироваться независимо от других.

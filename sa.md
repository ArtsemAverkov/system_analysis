...
- [x] - Сбор требований: Общение с заказчиками, пользователями и другими заинтересованными сторонами для понимания их потребностей и требований к системе.[>>>](#>>>), [Заинтересованные стороны](rb.md#Заинтересованные-стороны-и-приоритизация)
